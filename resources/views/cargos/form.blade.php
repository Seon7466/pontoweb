...
<div class="space-y-8">
    <section>
        <div class="mb-4">
            ...
            <p class="mt-1 text-sm text-slate-500">
                Identifique o cargo e seu departamento responsável.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <x-pw.select
                ...
                :value="old('departamento_id', $item?->departamento_id)"
            ...
            >
                @foreach ($departamentos as $id => $nome)
                    <option
                        value="{{ $id }}"
                        @selected((string) old('departamento_id', $item?->departamento_id) === (string) $id)
                    >
                        {{ $nome }}
                    </option>
                @endforeach
    ...
    <section class="border-t border-slate-200 pt-6">
        <div class="mb-4">
            ...
            <p class="mt-1 text-sm text-slate-500">
                Registre responsabilidades ou observações importantes.
            </p>
        </div>
        ...
        <div class="space-y-5">
            ...
            <x-pw.checkbox
                ...
                help="Cargos inativos permanecem no histórico, mas não devem ser utilizados em novos vínculos."
            />
        </div>
    </section>
</div>
