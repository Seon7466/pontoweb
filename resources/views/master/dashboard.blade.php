<x-app-layout>
    ...
    <x-pw.summary-grid>
        ...
        <x-pw.stat-card label="Planos ativos" :value="$indicadores['planos_ativos'] ?? 0" tone="warning" />
    </x-pw.summary-grid>
    ...
    <div class="mt-6 grid gap-5 md:grid-cols-3">
        ...
        <x-pw.card>
            <p class="text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">Próximo módulo</p>
            <h3 class="mt-2 text-lg font-semibold text-slate-900">Licenças</h3>
            <p class="mt-3 text-sm leading-6 text-slate-500">Vigência, limites contratados, suspensões e renovações por empresa.</p>
        </x-pw.card>
